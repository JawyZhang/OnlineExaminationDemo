...
<div class="container " id="row" style="margin: auto">
    <div class="row">
        <div class="myPanel col-md-offset-3 col-md-6">
            <img src="img/admin_system.png" class="col-md-offset-4 col-md-1 img-rounded  image center-block">

            <button class="btn  btn-primary col-md-3">下载试卷</button>
        </div>
    </div>
